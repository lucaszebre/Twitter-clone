...
?>
<div id="modalReply" class="relative hidden  z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
  <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
  <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      
    <div id="insideReply" class="w-11/12 md:w-6/12 sm:w-9/12 bg-white dark:bg-gray-900 rounded-2xl transform -translate-y-5">
  <section class="p-3 border-b border-gray-600">
    <svg onclick="closeReply()" id="closeReply" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600 hover:text-blue-400 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <form id="modalTweetReply" method="post"  enctype="multipart/form-data" class="w-full flex px-3 py-2">
    <div class="mr-1">
    <img class="rounded-full w-10 h-10" src=" <?php echo "./images/$pathprofile" ?>" alt=""> 
    </div>
    <div class="flex-1">
      <textarea id="content_reply" 
     
       name="content" maxlength="140" class="w-full p-2 bg-transparent outline-none placeholder-gray-400 text-gray-900 dark:text-white resize-none" rows="4" placeholder="What's happening?"></textarea>
      <div class="relative">
